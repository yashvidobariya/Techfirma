            ...
            <div className="home-team-flex">
                ...
                <div className="home-team-title">
                    ...
                    <motion.p initial={{ y: 100, opacity: 0 }}
                        ...
                        viewport={{ once: true }}>We hebben een bewezen staat van dienst in het leveren van hoogwaardige projecten op tijd en binnen het budget. Ons team excelleert in verschillende programmeertalen en frameworks, waaronder Java, Kotlin, Swift, React/React Native, Flutter en Angular. Met uitgebreide ervaring in databaseontwerp, cloud computing en agile ontwikkelmethodologieën zijn we uitgerust om elk project aan te kunnen, van eenvoudige websites tot complexe mobiele apps. Werk met ons samen om uw visie werkelijkheid te maken. Neem vandaag nog contact met ons op om meer te weten te komen over hoe onze diensten uw bedrijf kunnen laten floreren in de digitale wereld.</motion.p>
                </div>
